...
export const actSendFollowerRequest = (id) => {
  return (dispatch) => {
    return axios
      .post('/accounts/admin/followers/request', { userId: id })
      .then((res) => {
        debugger;
...
export const actPostCommentRequest = (data) => {
  return (dispatch) => {
    return axios
      .post(`posts/${data.postId}/comment`, { content: data.content })
      .then((res) => {
...
export const actFetchSearchResultRequest = (nickname) => {
  return (dispatch) => {
    return axios
      .get('accounts/search', { params: { q: nickname } })
      .then((res) => {
